...
class DesignDetail < ActiveRecord::Base
    ...
    # get_fields
    # return design_detail_fields for this design detail
    def get_fields
        return self.design_detail_fields.order("row_number ASC, created_at ASC")
    end

    # remove_fields
    # remove design_detail_fields for this design_detail
    def remove_fields
        fields = self.design_detail_fields
    ...
    def self.has_study_data(id)
        datapoints = DesignDetailDataPoint.where(:design_detail_field_id => id).all
