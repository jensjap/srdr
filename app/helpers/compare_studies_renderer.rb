class CompareStudiesRenderer    
    # @section_name and @section_code identifies the section to be rendered by Arm
    ...
    # Data member geter/setter methods
    ...
    def renderHTMLbyArmSelection(section_name,section_code,sidx,compareset,isdiffvalues,arm_idx,arm_id,arm_name,bl_idx,bl_id,armd_name)
        if (arm_id < 0) ||
            (bl_id < 0)
            return ""                                                        
        end          
