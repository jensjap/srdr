...
// Created: 6/3/2013 10:08:52 PM

function WebTrends(){
	var that=this;
	// begin: user modifiable
	this.dcsid="dcsulnsdnalq1tvppx89yhhqp_6i6o";
	this.domain="sdc2.ahrq.gov";
	this.timezone=-5;
	this.onsitedoms="";
	this.downloadtypes="xls,doc,pdf,txt,csv,zip,docx,xlsx,ppt,pptx,mp3,mp4,wmv,mov,xml,swf,exe";
